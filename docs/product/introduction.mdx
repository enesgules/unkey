---
title: What is Unkey?
description: "Unkey is a globally distributed API platform that ships your repo to production with built-in key issuance, rate limiting, and analytics."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Gateway" icon="shield-halved" href="/platform/gateway/overview">
...
| Spin up staging environments by hand | A preview environment for every branch |
| Stitch together per-region rollouts | Pick regions, deploy once |
...
<AccordionGroup>
  <Accordion title="Ship a production API from your repo" icon="rocket">
...
<CardGroup cols={2}>
  <Card title="I want to ship an API" icon="rocket" href="/build-and-deploy/overview">
    Deploy from GitHub or CLI. Multi-region, rollbacks, preview environments, the gateway in front.
  </Card>
